"""conftest for the orchestratord-kimi backend's own test suite.

Path setup: backend source first (so ``import orchestratord_kimi`` resolves
...
_BACKEND_SRC = _HERE.parents[1] / "src"   # backends/orchestratord-kimi/src
