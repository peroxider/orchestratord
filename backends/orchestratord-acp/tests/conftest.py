"""conftest for the orchestratord-acp backend's own test suite.

Path setup: backend source first (so ``import orchestratord_acp`` resolves
...
_BACKEND_SRC = _HERE.parents[1] / "src"   # backends/orchestratord-acp/src
