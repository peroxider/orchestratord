"""conftest for the orchestratord-cursor backend's own test suite.

Path setup: backend source first (so ``import orchestratord_cursor`` resolves
...
_BACKEND_SRC = _HERE.parents[1] / "src"   # backends/orchestratord-cursor/src
