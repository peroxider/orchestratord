...
| "HeuristicRouter 决策流与关键词桶顺序" | src/orchestratord/mode_router.py | 127-168 | ffa29427 |
| "swarm 优先于 debate/coordinator/pipeline 的桶顺序" | src/orchestratord/mode_router.py | 163-168 | 6f717b33 |
