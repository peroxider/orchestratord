...
| "HeuristicRouter 决策流与关键词桶顺序" | src/orchestratord/mode_router.py | 136-177 | 584f71ac |
| "swarm 优先于 debate/coordinator/pipeline 的桶顺序" | src/orchestratord/mode_router.py | 172-177 | 6f717b33 |
